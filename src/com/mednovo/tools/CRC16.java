...
public class CRC16{
    ...
    */
    ...
    public int getValue() {//CRC16校验返回值
        return value;
    }
...
//   byte[] sbuf = CRC16.getSendBuf("0103040a3d3fb7");
        String[] totalTemp = new String[11];//38
        int i = 0;
//读一个字
//   totalTemp[i++]="01";
//   totalTemp[i++]="03";//读
//   totalTemp[i++]="00";//寄存器地址
//   totalTemp[i++]="21";
//   totalTemp[i++]="00";//字节数
//   totalTemp[i++]="02";
//读一个字结束
...
//   totalTemp[i++]="06";//写一个
//   totalTemp[i++]="00";//寄存器地址
//   totalTemp[i++]="10"; //   totalTemp[i++]="00";//字节数
//   totalTemp[i++]="01";
//   totalTemp[i++]="00";//任务号
//   totalTemp[i++]="31";
//写一个字结束
...
//   byte[] sbuf = CRC16.getSendBuf("ffdd");
